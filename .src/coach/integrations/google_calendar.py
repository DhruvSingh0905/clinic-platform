"""Google Calendar integration for coach check-in scheduling.
...
from coach.config import GOOGLE_CALENDAR_CREDENTIALS_PATH, GOOGLE_CALENDAR_TOKEN_PATH
...
def get_google_calendar_service(coach_id: str):
